...
<div class="cointainer" style="position: relative; width: auto; overflow-X:hidden;">
      <div class="hero-image"><center>
        <div class="hero-text">
          ...
          <p class="container" style="padding: 0 100px;">Every large building needs an indoor map. Efficient shopping in short time's solutions for shopping malls improve the shopper experience, boosts visibility of your tenants, and increases internal efficiencies.</p> <br>
      ...
      <div class="row row-grid justify-content-between align-items-center">
        <div class="col-lg-6">
          ...
          <div class="btn-wrapper" style="position: relative; bottom: 10px;">
            ...
            <a href="#" class="btn btn-dark">Login Page</a>
          </div>
        </div><br>
